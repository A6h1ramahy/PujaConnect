        ...
        <div className="w-full max-w-lg md:max-w-3xl relative animate-slide-up">
          <div className="card p-6 md:p-8">
            ...
            <form onSubmit={handleSubmit} id="register-form" className="space-y-4">
                ...
                <div className="space-y-3.5">
                  ...
                  <div className="form-group">
                    ...
                    <div className="relative">
                      ...
                      <input id="reg-password" type={showPwd ? 'text' : 'password'} name="password" value={form.password} onChange={handleChange} placeholder="Min 8 chars, 1 upper, 1 digit" className="input-field pl-11 pr-11" autoComplete="new-password" />
              ...
              {form.role === 'pandit' && (
                <div className="p-2.5 rounded-xl bg-amber-50 dark:bg-amber-900/20 border border-amber-100 dark:border-amber-800 text-[11px] text-amber-700 dark:text-amber-400">
