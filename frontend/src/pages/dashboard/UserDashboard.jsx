      ...
      <div className="page-container py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1 space-y-2">
            ...
            <Link to="/pandits" id="user-find-pandits" className="w-full flex items-center gap-3 px-4 py-3 rounded-xl font-medium text-sm text-stone-600 dark:text-stone-300 hover:bg-stone-100 dark:hover:bg-stone-800">
              ...
              <div className="animate-fade-in">
                ...
                {loading ? (
                  ...
                  <div className="space-y-3">
                    {bookings.map((b) => (
                      <div key={b._id} id={`booking-${b._id}`} className="card p-5 flex flex-col sm:flex-row sm:items-center gap-4">
