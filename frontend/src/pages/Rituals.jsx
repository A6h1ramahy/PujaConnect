...
import { RitualCardSkeleton } from '../components/common/SkeletonLoader';
...
const Rituals = () => {
  ...
  return (
    <PageTransition>
      <div className="min-h-screen bg-light-bg dark:bg-dark-bg transition-colors duration-300 pb-16">
        {/* Header Banner */}
        <div className="bg-light-surface dark:bg-dark-surface border-b border-light-border dark:border-dark-border py-12 relative overflow-hidden transition-colors duration-300">
        ...
        <div className="page-container py-8">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            `}>
              ...
              <div className="absolute top-0 bottom-0 left-0 w-80 max-w-[90vw] lg:w-72 lg:relative lg:top-auto lg:bottom-auto lg:left-auto bg-white dark:bg-dark-card border-r lg:border border-light-border dark:border-dark-border lg:rounded-2xl p-6 overflow-y-auto h-full lg:h-auto shadow-card-light dark:shadow-card-dark flex flex-col gap-6 transition-colors duration-300">
                ...
                <div className="hidden lg:flex justify-between items-center">
                  <h3 className="font-display font-bold text-stone-900 dark:text-stone-100 flex items-center gap-2 text-base font-semibold">
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-bold text-stone-400 dark:text-stone-500 uppercase tracking-wider">Search</label>
                ...
                {/* Location Type */}
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-bold text-stone-400 dark:text-stone-500 uppercase tracking-wider">Location Type</label>
                ...
                <div className="flex items-center justify-between py-2 border-t border-b border-light-border dark:border-dark-border">
                  <span className="text-[10px] font-bold text-stone-400 dark:text-stone-500 uppercase tracking-wider">Most Popular Only</span>
                ...
                <div className="flex flex-col gap-2 pb-2 border-b border-light-border dark:border-dark-border">
                  <label className="text-[10px] font-bold text-stone-400 dark:text-stone-500 uppercase tracking-wider">Occasion</label>
                  <select
                ...
                {/* Categories List */}
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-bold text-stone-400 dark:text-stone-500 uppercase tracking-wider">Categories</label>
            ...
            <div className="flex-1">
              ...
              <div className="flex lg:hidden justify-between items-center gap-4 mb-6 p-4 rounded-xl bg-white dark:bg-dark-card border border-light-border dark:border-dark-border transition-colors duration-300">
              ...
              <div className="hidden lg:flex flex-col gap-3 mb-6">
                ...
                {getActiveFilterCount() > 0 && (
                  <div className="flex flex-wrap gap-2 items-center">
                    ...
                    {search.trim() && (
                      <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs bg-stone-100 dark:bg-stone-800 text-stone-600 dark:text-stone-300 border border-light-border dark:border-dark-border/40">
                        Search: "{search}"
                    ...
                    {category && (
                      <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs bg-saffron-50 dark:bg-saffron-950/20 text-saffron-700 dark:text-saffron-400 border border-saffron-100 dark:border-saffron-900/30">
                        {category}
                        <HiX className="cursor-pointer text-saffron-400 hover:text-saffron-650" onClick={() => setCategory('')} />
                      </span>
                    )}
                    {locationType && (
                      <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs bg-emerald-50 dark:bg-emerald-950/20 text-emerald-700 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-900/30">
                        ...
                        <HiX className="cursor-pointer text-emerald-400 hover:text-emerald-650" onClick={() => setLocationType('')} />
                      </span>
                    )}
                    {popularOnly && (
                      <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs bg-amber-50 dark:bg-amber-950/20 text-amber-700 dark:text-amber-400 border border-amber-100 dark:border-amber-900/30">
                        🔥 Most Popular
                        <HiX className="cursor-pointer text-amber-400 hover:text-amber-650" onClick={() => setPopularOnly(false)} />
                      </span>
                    )}
                    {occasion && (
                      <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-xs bg-indigo-50 dark:bg-indigo-950/20 text-indigo-750 dark:text-indigo-455 border border-indigo-100 dark:border-indigo-900/30">
                        🏷️ {occasion}
                  ...
                  {rituals.map((ritual, i) => (
                    <StaggerItem key={ritual._id}>
                      <div 
                        ...
                        className="card-hover p-5 flex flex-col justify-between h-full bg-white dark:bg-dark-card border border-light-border dark:border-dark-border group relative overflow-hidden"
                      >
                        {ritual.popular && (
                        ...
                        <div className="border-t border-light-border dark:border-dark-border pt-3 mt-auto">
                          ...
                          <div className="flex gap-2">
                            <Link 
                              ...
                              className="flex-1 flex items-center justify-center gap-1 py-2 rounded-xl text-xs font-bold bg-stone-100 dark:bg-stone-800 text-stone-700 dark:text-stone-300 hover:bg-stone-250 dark:hover:bg-stone-700 transition-colors border border-transparent"
                            >
                              Details 👁️
                            </Link>
                            <Link 
