  ...
  if (loading) return (
    <PageTransition>
      <div className="min-h-screen flex items-center justify-center bg-light-bg dark:bg-dark-bg">
        <LoadingSpinner size="lg" text="Loading Pandit profile..." />
      </div>
    </PageTransition>
  );
  if (!pandit) return (
    <PageTransition>
      <div className="min-h-screen flex items-center justify-center bg-light-bg dark:bg-dark-bg">
        <div className="text-center p-8 bg-white dark:bg-dark-card border border-light-border dark:border-dark-border rounded-2xl shadow-sm max-w-sm mx-auto">
          <p className="text-stone-500 dark:text-stone-400 font-medium">Pandit profile not found.</p>
        ...
        <div className="page-container pb-12">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-4">
              <ScrollReveal>
                <div className="card-hover p-6 text-center bg-white dark:bg-dark-card border border-light-border dark:border-dark-border relative overflow-hidden">
                  {/* Photo */}
                  ...
                  {user?.role === 'user' ? (
                    ...
                    <div className="mt-6 p-5 border border-dashed border-light-border dark:border-dark-border rounded-2xl bg-light-surface dark:bg-dark-surface/40 text-center animate-fade-in">
                      <p className="text-xs font-medium text-stone-600 dark:text-stone-350 mb-4 leading-relaxed">
              ...
              {user && supportedRituals?.length > 0 && (
                <ScrollReveal>
                  <div className="card-hover p-5 bg-white dark:bg-dark-card border border-light-border dark:border-dark-border">
                    ...
                    <div className="space-y-2">
                      {supportedRituals.map((ritual) => {
                        ...
                        return (
                          <div key={ritual._id} className="flex justify-between items-center text-sm py-2 border-b border-light-border dark:border-dark-border last:border-0 animate-fade-in">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              {activeTab === 'about' && (
                <ScrollReveal>
                  <div className="card-hover p-6 bg-white dark:bg-dark-card border border-light-border dark:border-dark-border relative overflow-hidden">
              ...
              {activeTab === 'rituals' && (
                <StaggerContainer className="space-y-3">
                  {supportedRituals?.length > 0 ? (
                    ...
                    <div className="card p-8 text-center text-stone-400 bg-white dark:bg-dark-card border border-light-border dark:border-dark-border rounded-2xl">No rituals listed yet.</div>
                  )}
                </StaggerContainer>
              )}
                        ...
                        {availability.length > 0 ? (
                          <div className="space-y-3 animate-fade-in">
                            {availability.map((slot) => (
                              <div key={slot._id} className="card-hover p-4 bg-white dark:bg-dark-card border border-light-border dark:border-dark-border">
                                      ...
                                      <span
                                        ...
                                        className={`px-3 py-1 rounded-lg text-xs font-medium ${
                                          ts.isBooked
                                            ...
                                            : 'bg-emerald-550/10 dark:bg-emerald-950/20 text-emerald-700 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-900/30'
                                        }`}
                                      >
                          ...
                          <div className="card p-8 text-center bg-white dark:bg-dark-card border border-light-border dark:border-dark-border rounded-2xl">
